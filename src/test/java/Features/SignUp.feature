Feature: Sign Up new Customer Feature 
	...
	And I enter the firstname as"choudhury", last name as "iqbal", mobile no as "1111111111", email as "E@mail.com",password as"password" and ;confirm it "Confirm Password" 
